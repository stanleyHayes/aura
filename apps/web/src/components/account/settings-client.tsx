...
export function AccountSettingsClient({ session }: { session: AppSession }) {
  ...
  return (
    <>
      ...
      {/* Masonry (CSS columns) so cards of differing height pack tightly — a
          2-col grid forces every row to the tallest card, leaving ugly gaps
          under short cards next to the tall Security/MFA card. */}
      <div className="columns-1 gap-4 [&>*]:mb-4 [&>*]:break-inside-avoid xl:columns-2">
        <SettingCard
          icon={UserCog}
          title="Account"
          description="Personal account details connected to this session."
        >
        ...
        <SettingCard
          icon={ShieldCheck}
          title="Security"
          description="Keep track of session and sign-in protection."
        >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <ol className="mt-2 space-y-1 text-sm leading-6 text-[var(--color-muted-foreground)]">
                        <li>
                          ...
                          Microsoft Authenticator, 1Password, or another TOTP
                          app.
                        </li>
                        <li>
                        ...
                        <li>
                          3. Enter the six-digit code from the app to finish.
                        </li>
                      </ol>
                    </div>
                  </div>
        ...
        <SettingCard
          icon={Bell}
          title="Preferences"
          description="Choose how this browser presents account feedback."
        >
          <div className="grid gap-3">
            <PreferenceRow
            ...
            <PreferenceRow
              ...
              onChange={(checked) => updatePreference("spokenGuide", checked)}
            />
            <PreferenceRow
            ...
            />
            <Button type="button" className="w-full sm:w-fit" onClick={savePreferences}>
              <Save className="size-4" aria-hidden />
              Save settings
            </Button>
          </div>
        ...
        >
          <div className="flex items-start gap-3 rounded-lg border border-[var(--color-border)] bg-[color-mix(in_oklch,var(--color-muted)_35%,transparent)] p-4 text-sm text-[var(--color-muted-foreground)]">
            ...
            <p>
              Use the theme button in the top navigation to switch between light
              and dark mode.
            </p>
          </div>
        </SettingCard>
        ...
        >
          <p className="rounded-lg border border-[var(--color-border)] bg-[color-mix(in_oklch,var(--color-muted)_35%,transparent)] p-4 text-sm leading-6 text-[var(--color-muted-foreground)]">
            User guide opens the dedicated workflow reference. Replay tour starts
            the step-by-step dashboard tour again.
          </p>
        </SettingCard>
      </div>
    </>
